...
%XProcessLogRE::patterns = (
    ...
    'all_special' => [
        [qr/\b\d+\s(?:failed|errors?)\b/i                         , qr/\b0+\s(?:failed|errors?)\b|error.h|^Win32\\SINGLE_SETUP - 1 error\(s\)|\[WARNING\]/i, undef],
    ...
    'all_general' => [
        ...
        [qr/\bdoes not exist\b/i                                  , qr/The target \"BeforeGenerateProjectPriFile\" listed in a BeforeTargets attribute at \".*?Microsoft.NuGet.targets \(186,61\)"|\[javac\] \[JLin\] .+\$\{compiler\.bootclasspath\}\" does not exist and will be ignored\.$|\bdoes not exist, re|Will create one\.|\[uptodate\]|info \w+ classpath entry|SASSERTMSG|\bdoes not exist, creating it now\.|\[delete\] Directory does not exist:|\[INFO\]|\[warn\]|println/i, undef],
        ...
        [qr/\bno such file\b/i                                    , qr/INSTALLSTARTER\.GCCE:|BOOTAPPS60\.GCCE:/, undef],
