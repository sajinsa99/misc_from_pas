...
$HTTP_TORCHE = "https://builddashboard.pgdev.sap.corp/Torch";
$HTTP_CIS = "http://cis-wdf.pgdev.sap.corp:1080/cgi-bin/CIS.pl";
$Project = $ENV{PROJECT};
$Site = $ENV{SITE};
...
foreach my $thisSite (qw(Levallois Vancouver Bangalore Walldorf)) {
	...
	if(open(SITE,"Site.pm")) {
		while(<SITE>) {
			...
			if (/^\$VARS2\{$thisSite\}\{win32_x86\}\s*\{HTTP_DIR\}\s*\=\s*\$ENV\{PROJECT\}\s*eq\s*\'documentation\'\s*\?\s*\"(.+?)\"\s*\:\s*\"(.+?)\"/i) {			
				$ENV{PROJECT} eq 'documentation' ? 	my $path = "$1\\$Context\\$BuildName" :  my $path = "$2\\$Context\\$BuildName";	
				($path) =~ s-\\\\-\\-g;
				($path) =~ s-\\-\/-g;
				if(($^O eq "MSWin32")) {
					if( -e "$path") {
			...
			if (/^\$VARS2\{$thisSite\}\{Unix\}\s*\{HTTP_DIR\}\s*\=\s*\$ENV\{PROJECT\}\s*eq\s*\'documentation\'\s*\?\s*\"(.+?)\"\s*\:\s*\"(.+?)\"/i) {	
				$ENV{PROJECT} eq 'documentation' ? 	my $path = "$1\\$Context\\$BuildName" :  my $path = "$2\\$Context\\$BuildName";	
				($path) =~ s-\\\\-\\-g;
				($path) =~ s-\\-\/-g;
				if(($^O eq "MSWin32")) {
...
<table class=MsoNormalTable style=\'background:#404040;border-collapse:collapse\'>
 <tr>
  ...
  style=\'font-size:12.0pt;font-family:Verdana;color:white;font-weight:bold\'>Highlights</span></b><font
...
<table class=MsoNormalTable
 ...
 <tr>
  ...
  color:blue\'><o:p></o:p></span>&nbsp;<font color=#000000><a href="',$HTTP_CIS,'?streams=',$Context,'&tag=',$BuildName,'">CIS</a></p>
  </td>
 </tr>
 ');
 my $flagBin = 0;
...
<table class=MsoNormalTable style=\'background:#404040;border-collapse:collapse\'>
 <tr>
  ...
  padding:0in 5.4pt 0in 5.4pt\'>
  <p><b><font size=3 color=white face=Verdana><span
  style=\'font-size:12.0pt;font-family:Verdana;color:white;font-weight:bold\'>Smoke Tests</span></b><font size=1 color=white face=Verdana><span
  style=\'font-size:8.0pt;font-family:Verdana;color:white\'><o:p></o:p></span></p>
  </td>
 </tr>
</table>
...
<p><b><font size=1 color=navy face=Verdana><span
style=\'font-size:8.0pt;font-family:Verdana;color:navy;font-weight:bold\'>Smoke test configuration<o:p></o:p></span></b></p>

<p><b><font size=1 color=navy face=Verdana><span
style=\'font-size:8.0pt;font-family:Verdana;color:navy;font-weight:bold\'><o:p>&nbsp;</o:p></span></b></p>

<table class=MsoNormalTable 
 style=\'border-collapse:collapse\'>
 <tr style=\'height:12.7pt\'>
  <td valign=top class=smokeTestTd>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><span style=\'font-size:8.0pt;font-family:Verdana\'>Language<o:p></o:p></span></p>
  </td>
  <td valign=top style=\'width:441.0pt;border:solid #999999 1.0pt;border-left:none;padding:0in 5.4pt 0in 5.4pt;height:12.7pt\'>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><span style=\'font-size:8.0pt;font-family:Verdana\'>English<o:p></o:p></span></p>
  </td>
 </tr>');
 print(HTML '
 <tr style=\'height:12.7pt\'>
  <td valign=top class=smokeTestTd>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><span style=\'font-size:8.0pt;font-family:Verdana\'>Server/Client
  OS Version<o:p></o:p></span></p>
  </td>
  <td valign=top class=smokeTestTdCol2>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><span style=\'font-size:8.0pt;font-family:Verdana\'>Windows
  ...
  w:st="on"><st1:City
   ...
   tabIndex="0" w:st="on">Server Enterprise</st1:City></st1:place> SP2<o:p></o:p></span></p>
  </td>
 </tr>
 <tr style=\'height:12.7pt\'>
  <td valign=top class=smokeTestTd>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><font
  size=1 face=Verdana><span style=\'font-size:8.0pt;font-family:Verdana\'>Browser<o:p></o:p></span></p>
  </td>
  <td valign=top class=smokeTestTdCol2>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><span style=\'font-size:8.0pt;font-family:Verdana\'>IE 7
  <o:p></o:p></span></p>
  </td>
 </tr>
...
print(HTML '
 <tr style=\'height:12.7pt\'>
  <td valign=top class=smokeTestTd>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><font
  size=1 face=Verdana><span style=\'font-size:8.0pt;font-family:Verdana\'>CMS<o:p></o:p></span></p>
  </td>
  <td valign=top class=smokeTestTdCol2>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><span style=\'font-size:8.0pt;font-family:Verdana\'>MySQL<o:p></o:p></span></p>
  </td>
 </tr>
 <tr style=\'height:12.7pt\'>
  <td valign=top class=smokeTestTd>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><span style=\'font-size:8.0pt;font-family:Verdana\'>Web App
  Server<o:p></o:p></span></p>
  </td>
  <td valign=top class=smokeTestTdCol2>
  <p style=\'mso-margin-top-alt:auto;mso-margin-bottom-alt:auto\'><span style=\'font-size:8.0pt;font-family:Verdana\'>Tomcat
  (for Java Infoview)<o:p></o:p></span></p>
  </td>
 </tr>
</table>
');
...
# Mail
$SMTPTO .= ($SMTPTO?';':'').$ENV{SMTPTO_RECIPIENTS_WHEN_ERRORS} if($ENV{SMTPTO_RECIPIENTS_WHEN_ERRORS} and $Errors); 
if($SMTPTO)
{
